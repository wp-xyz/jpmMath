...
procedure AiryZeros(NT, KF: integer; out XA, XB, XC, XD: TFloatArray);

function Beta(P, Q: Float): Float;
...
!  Output:  gamma(x)
!
!  Note:    A version with complex argument is available in folder "complex"
! =============================================================================}
function Gamma(X: double): double;
const
  G: array[1..26] of Float = (
