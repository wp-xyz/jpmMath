...
{                                                       }
{*******************************************************}
{Version spéciale pour tetriss.pas}
unit WinCrt1;
...
begin
  ...
  begin
    ...
    Case M.wParam Of
      vk_Right: Tecla:=#77;  {flèche droite}
      vk_Left : Tecla:=#75;  {flèche gauche}
      vk_Up   : Tecla:=#76;  {flèche haut}
      vk_Down : Tecla:=#78;  {flèche bas}
      vk_End  : Tecla:=#27;  {Fin pour sortir}
    End;
    TranslateMessage(M);
    DispatchMessage(M);
  end;
